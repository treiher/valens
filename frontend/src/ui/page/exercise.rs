            ...
            common::view_chart(
                ...
                common::plot_chart(
                    &[common::PlotData {
                        ...
                        values_low: None,
                        plots: common::plot_area_with_border(common::COLOR_TUT, common::COLOR_TUT, 0.3, 2),
                        params: common::PlotParams::primary_range(0., 10.),
                    }],
                    interval,
                    theme,
                ...
                &training_sessions
                    ...
                    .flat_map(|s| s
                        ...
                        .filter_map(|e| match e {
                            storage::TrainingSessionElement::Set { weight, .. } =>
                ...
                common::plot_min_avg_max(
                    &training_sessions
                        ...
                        .flat_map(|s| s
                            ...
                            .filter_map(|e| match e {
                                #[allow(clippy::cast_precision_loss)]
                                storage::TrainingSessionElement::Set { time, .. } =>
