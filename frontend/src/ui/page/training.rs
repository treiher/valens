...
pub fn view_charts<Ms>(
    ...
    nodes![
        common::view_chart(
            &[
                ("Short-term load", common::COLOR_LOAD, 0.9),
                ("Long-term load", common::COLOR_LONG_TERM_LOAD, 0.3)
            ],
            common::plot_chart(
                &[
                    common::PlotData {
                    ...
                    common::PlotData {
                        ...
                        values_low: None,
                        plots: common::plot_line(common::COLOR_LOAD, 0.9),
                        params: common::PlotParams::primary_range(0., 10.),
                    }
                ],
                interval,
        ...
        IF![
            show_rpe =>
            common::view_chart(
                &[("RPE (7 day average)", common::COLOR_RPE, 0.9)],
                common::plot_chart(
                    &average_7day_rpe.iter().map(|values| common::PlotData{values_high: values.clone(),
                        values_low: None,
                        plots: common::plot_line(common::COLOR_RPE, 0.9),
