...
use crate::{
    ...
    component::{
        element::{
            Block, Calendar, Chart, ChartLabel, DeleteConfirmationDialog, Dialog, Error,
    ...
    match &*dialog.read() {
        ...
        | BodyFatDialog::Edit {
            ...
            Dialog {
                ...
                content: rsx! {
                    Block {
                        content: rsx! { "Measure your body fat using a skinfold caliper." }
                    },
                    InputField {
        ...
        BodyFatDialog::Delete(body_fat) => rsx! {
            DeleteConfirmationDialog {
                ...
                element_name: rsx! { span { "of " NoWrap { element: rsx! { "{body_fat.date}" } } } },
                delete_event: delete,
                cancel_event: close,
