...
#[component]
pub fn Block(content: Element) -> Element {
    rsx! {
...
#[component]
pub fn WhiteBox(content: Element) -> Element {
    rsx! {
...
#[component]
pub fn DataBox(title: String, content: Element) -> Element {
    rsx! {
        div {
...
#[component]
pub fn Message(body: Element, color: Color) -> Element {
    rsx! {
        div {
...
#[component]
pub fn IconText(icon: String, text: String, color: Option<Color>) -> Element {
    rsx! {
        span {
            class: "icon-text",
...
pub struct ElementWithDescriptionProps {
    element: Element,
    description: String,
...
#[component]
pub fn ElementWithDescription(props: ElementWithDescriptionProps) -> Element {
    rsx! {
        div {
            class: "dropdown is-right is-hoverable",
            class: if props.right_aligned.unwrap_or_default() { "is-right" },
            div {
...
#[component]
pub fn Container(content: Element, has_text_centered: Option<bool>) -> Element {
    rsx! {
        div {
...
#[component]
pub fn Title(title: String, y_margin: Option<u8>) -> Element {
    rsx! {
        div {
            class: "container has-text-centered my-{y_margin.unwrap_or(3)}",
...
#[component]
pub fn NoWrap(element: Element) -> Element {
    rsx! {
        span { style: "white-space:nowrap", {element} }
    }
}
