            ...
            domain::RoutinePart::RoutineSection {
                ...
                parts: vec![
                    domain::RoutinePart::RoutineActivity {
                        ...
                        tempo: domain::Tempo::new(&[2]).unwrap(),
                    ...
                    domain::RoutinePart::RoutineActivity {
                        ...
                        tempo: domain::Tempo::new(&[60]).unwrap(),
            ...
            domain::RoutinePart::RoutineSection {
                ...
                parts: vec![
                    ...
                    domain::RoutinePart::RoutineActivity {
                        exercise_id: domain::ExerciseID::nil(),
                        reps: domain::Reps::default(),
                        tempo: domain::Tempo::new(&[30]).unwrap(),
                        weight: domain::Weight::default(),
                        rpe: domain::RPE::ZERO,
                        automatic: true,
                    },
    ...
    std::sync::LazyLock::new(|| domain::TrainingSession {
        ...
        elements: vec![
            domain::TrainingSessionElement::Set {
                ...
                target_tempo: domain::Tempo::new(&[4]).unwrap(),
                target_weight: domain::Weight::new(40.0).unwrap(),
