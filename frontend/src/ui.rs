...
fn update(msg: Msg, model: &mut Model, orders: &mut impl Orders<Msg>) {
    match msg {
        ...
        Msg::GoUp => match &model.page {
            ...
            Some(Page::Admin(_)) => {
                orders.request_url(crate::ui::Urls::new(&model.data.base_url).login());
            }
            Some(
                Page::BodyWeight(_)
                | Page::BodyFat(_)
            ...
            | None => {
                orders.request_url(crate::ui::Urls::new(&model.data.base_url).home());
            }
            Some(Page::Exercise(_)) => {
                orders.request_url(crate::ui::Urls::new(&model.data.base_url).exercises());
            }
            Some(Page::Routine(_)) => {
                orders.request_url(crate::ui::Urls::new(&model.data.base_url).routines());
            }
            Some(
                ...
                orders.request_url(crate::ui::Urls::new(&model.data.base_url).training());
            }
        },
        Msg::LogOut => {
            ...
            p![
                ...
                div![
                    ...
                    p![
                        ...
                        button![
                            C!["button"],
                            C![IF![data_model.settings.theme == Theme::Light => "is-link"]],
                            &ev(Ev::Click, move |_| Msg::SetTheme(Theme::Light)),
                    ...
                    p![
                        ...
                        span![
                            C!["button"],
                            C![IF![data_model.settings.theme == Theme::Dark => "is-link"]],
                            &ev(Ev::Click, move |_| Msg::SetTheme(Theme::Dark)),
                    ...
                    p![
                        ...
                        span![
                            C!["button"],
                            C![IF![data_model.settings.theme == Theme::System => "is-link"]],
                            &ev(Ev::Click, move |_| Msg::SetTheme(Theme::System)),
