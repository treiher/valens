...
INSERT INTO "alembic_version" VALUES('4b6051594962');
...
CREATE TABLE routine_exercise (
	...
	CONSTRAINT ck_routine_exercise_position_type_integer CHECK (typeof(position) = 'integer'),
	CONSTRAINT ck_routine_exercise_sets_gt_0 CHECK (sets > 0),
	CONSTRAINT ck_routine_exercise_sets_type_integer CHECK (typeof(sets) = 'integer'),
	CONSTRAINT fk_routine_exercise_exercise_id_exercise FOREIGN KEY(exercise_id) REFERENCES exercise (id) ON DELETE CASCADE,
	CONSTRAINT fk_routine_exercise_routine_id_routine FOREIGN KEY(routine_id) REFERENCES routine (id) ON DELETE CASCADE,
	CONSTRAINT pk_routine_exercise PRIMARY KEY (routine_id, position)
);
INSERT INTO "routine_exercise" VALUES(1,2,1,2);
INSERT INTO "routine_exercise" VALUES(1,1,3,1);
INSERT INTO "routine_exercise" VALUES(1,3,3,3);
INSERT INTO "routine_exercise" VALUES(3,1,3,5);
INSERT INTO "routine_exercise" VALUES(2,1,2,3);
INSERT INTO "routine_exercise" VALUES(2,2,4,4);
CREATE TABLE user (
	id INTEGER NOT NULL,
	name VARCHAR NOT NULL,
